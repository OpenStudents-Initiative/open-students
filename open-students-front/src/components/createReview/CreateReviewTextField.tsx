...
const CreateReviewTextField = ({ reviewText, setReviewText, showError, setShowError }: CreateReviewTextFieldProps) => {

    const intl = useIntl();
    const textConstants = {
        createReviewText: intl.formatMessage({ id: 'createReviewText' }),
        textfieldCannotBeEmpty: intl.formatMessage({ id: 'textfieldCannotBeEmpty' }),
    }
